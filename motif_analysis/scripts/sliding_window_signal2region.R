...
option_list = list(
    ...
    make_option(c('-m', '--mode'), type='character', default='positive',
                help='match the mode with the input file (positive|negative)', metavar='character'),
