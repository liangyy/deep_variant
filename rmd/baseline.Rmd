...
Baseline method is used to compare the performance. As DeepSEA, gkm-SVM is selected as baseline classifier. Here are several issues in making such comparison:
