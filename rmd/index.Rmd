...
0. Baseline classifier. [here](baseline.html)
    - Train an SVM or logistic classifier using JASPAR as annotation
        - ROC/PR curve 
          [Stage1 JASPAR logistic](https://rawgit.com/liangyy/deep_variant/code/pr_roc_curve/report/JASPAR_plot.html), 
          [Stage1 JASPAR logistic, reweighted](https://rawgit.com/liangyy/deep_variant/code/pr_roc_curve/report/JASPAR.reweight_plot.html)
        - Compare performance with DeepSEA representation 
          [Stage1 here](https://rawgit.com/liangyy/deep_variant/code/performance_comparison/report/deep_brain.auc_comparison.html), 
          [Stage1 with reweight](https://rawgit.com/liangyy/deep_variant/code/performance_comparison/report/deep_brain_reweight.auc_comparison.html)
    - Gkm-SVM classifier is trained on 5000 positive and 5000 negative sequences one annotation at a time.
        - ROC/PR curve 
          [Stage1 gkmsvm_on_deepsea_testing](https://rawgit.com/liangyy/deep_variant/code/pr_roc_curve/report/type1.gkm_deepsea_plot.html), 
          [Stage1 gkmsvm_on_deepsea_testing.reweight](https://rawgit.com/liangyy/deep_variant/code/pr_roc_curve/report/type1.gkm_deepsea.reweight_plot.html)
        - Compare performance with DeepSEA representation 
          [Stage1 here](https://rawgit.com/liangyy/deep_variant/code/performance_comparison/report/gkm_vs_type1_on_deepsea_test.auc_comparison.html)
1. Use DeepSEA sequences and DeepSEA feature representation. 
    - See results and analysis 
      [Stage1 here](type1.html). 
    - See performance on new sequences 
      [Stage1 here](type1_newseq.html)
    - ROC/PR curve 
      [Stage1 Type1](http://htmlpreview.github.io/?https://github.com/liangyy/deep_variant/blob/code/pr_roc_curve/report/deepsea_vs_newseq_plot.html), 
      [Stage1 Type1, reweighted](https://rawgit.com/liangyy/deep_variant/code/pr_roc_curve/report/type1.reweight_plot.html)
    - Evalution using allelic imbalance site 
      [Stage1 here](type1_allelic_imbalance.html)
2. Use DeepSEA sequences but train a new model using the same architecture as DeepSEA. 
    - See results and analysis 
      [Stage1 here](type2.html). **ONGOING**
