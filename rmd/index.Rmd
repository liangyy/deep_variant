...
4. **Application**
    - GWAS SNPs. See [here](gwas.html)
5. **Data Quality**: 
    - GC content. [DeepSEA test set](http://htmlpreview.github.io/?https://github.com/liangyy/deep_variant/blob/code/gc_content/report/deepsea.gc_content.html), [Sequences extracted from BED file](http://htmlpreview.github.io/?https://github.com/liangyy/deep_variant/blob/code/gc_content/report/extracted.gc_content.html)
