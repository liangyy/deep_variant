...
0. Baseline classifier. [here](baseline.html)
    ...
    - Gkm-SVM classifier is trained on 5000 positive and 5000 negative sequences one annotation at a time.
        - ROC/PR curve [gkmsvm_on_deepsea_testing](https://rawgit.com/liangyy/deep_variant/code/pr_roc_curve/report/type1.gkm_deepsea_plot.html), [gkmsvm_on_deepsea_testing.reweight](https://rawgit.com/liangyy/deep_variant/code/pr_roc_curve/report/type1.gkm_deepsea.reweight_plot.html)
        - Compare performance with DeepSEA representation [here](https://rawgit.com/liangyy/deep_variant/code/performance_comparison/report/gkm_vs_type1_on_deepsea_test.auc_comparison.html)
...
3. **Performance Evaluation**
    ...
    - Redo DeepSEA evaluation on DNase footprint data [here](deepsea_dgf.html)
4. **Application**
...
6. **Allelic Imbalance Analysis**:
    ...
    - Rerun analysis considering both imbalanced variants and balanced variants [here](allelic_imbalance_rerun.html)
