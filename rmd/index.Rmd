...
0. Baseline classifier. [here](baseline.html)
    ...
    - Compare performance with DeepSEA representation [here](https://rawgit.com/liangyy/deep_variant/code/performance_comparison/report/deep_brain.auc_comparison.html)
...
* 5/29/17:
    7. GC content bias in training and testing data
        ...
        - Construct a sequence set with matched GC content in positive and negative instances **TODO**
